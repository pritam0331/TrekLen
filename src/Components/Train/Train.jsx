    ...
    <>
        ...
        <div className="train-booking-container">
          ...
          <div className="train-booking-form">
            ...
            <div className="train-bottom-options">
              ...
              <div className="train-spacer"></div>
              <button className="train-search-button">
          ...
          {trips.map((trip, index) => (
            <div className="card" key={index}>
              ...
              <div className="card-content">
                <h3>{trip.title}</h3>
                <p><MapPin size={18} /> {trip.trainType}</p>
                <p><trainIcon size={18} /> {trip.company}</p>
      ...
      <section className="travel-section">
        <div className="train-top-content">
          ...
          <p>Discover most affordable train and travel options to popular destinations below.</p>
        </div>
